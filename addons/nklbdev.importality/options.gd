...
const CREATE_RESET_ANIMATION: StringName = &"animation/create_reset_animation"
const SPLIT_LAYERS: StringName = &"layers/split_layers"
const LAYERS_ANIMATION_NAME_FORMAT: StringName = &"layers/animation_name_format"
const ROOT_NODE_NAME: StringName = &"root_node_name"
const ANIMATION_STRATEGY: StringName = &"sprite/animation_strategy"
